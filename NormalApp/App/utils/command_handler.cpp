...
// //     // create JSON
// //     nlohmann::json j;
// //     j["opType"] = static_cast<std::uint8_t>(opType);
// //     j["key"] = key;
...
// //     // Serialize JSON
// //     uint32_t json_size = serialized_json.size();
// //     data.insert(data.end(), reinterpret_cast<const char*>(&json_size), reinterpret_cast<const char*>(&json_size) + sizeof(json_size));
// //     data.insert(data.end(), serialized_json.begin(), serialized_json.end());

// //     return data;
// // }

// std::vector<char> CommandHandler::serializeCommand(const std::vector<Procedure> &procedures) {
//     std::vector<char> data;

//     // create JSON array
//     nlohmann::json json_array = nlohmann::json::array();
    
//     for (const auto &pro: procedures) {
